...
public class SalesAnalysisServiceImpl implements ISalesAnalysisService {
		...
		for(int i = 0; i < headmonthVO.size(); i++) {
			...
			switch(i) {
				case 0 :
					...
					int janincomePrice = (int) (monthVO.getMonthtotalprofitPrice() - (monthVO.getMonthtotalPrice()*0.1)); 
				...
				case 1 :
					...
					int febincomePrice = (int) (monthVO.getMonthtotalprofitPrice() - (monthVO.getMonthtotalPrice()*0.1)); 
				...
				case 2 :
					...
					int marincomePrice = (int) (monthVO.getMonthtotalprofitPrice() - (monthVO.getMonthtotalPrice()*0.1)); 
				...
				case 3 :
					...
					int aprincomePrice = (int) (monthVO.getMonthtotalprofitPrice() - (monthVO.getMonthtotalPrice()*0.1)); 
				...
				case 4 :
					...
					int mayincomePrice = (int) (monthVO.getMonthtotalprofitPrice() - (monthVO.getMonthtotalPrice()*0.1)); 
				...
				case 5 :
					...
					int junincomePrice = (int) (monthVO.getMonthtotalprofitPrice() - (monthVO.getMonthtotalPrice()*0.1)); 
				...
				case 6 :
					...
					int julyincomePrice = (int) (monthVO.getMonthtotalprofitPrice() - (monthVO.getMonthtotalPrice()*0.1)); 
				...
				case 7 :
					...
					int augincomePrice = (int) (monthVO.getMonthtotalprofitPrice() - (monthVO.getMonthtotalPrice()*0.1)); 
				...
				case 8 :
					...
					int sepincomePrice = (int) (monthVO.getMonthtotalprofitPrice() - (monthVO.getMonthtotalPrice()*0.1)); 
				...
				case 9 :
					...
					int octincomePrice = (int) (monthVO.getMonthtotalprofitPrice() - (monthVO.getMonthtotalPrice()*0.1)); 
				...
				case 10 :
					...
					int novincomePrice = (int) (monthVO.getMonthtotalprofitPrice() - (monthVO.getMonthtotalPrice()*0.1)); 
				...
				case 11 :
					...
					int decincomePrice = (int) (monthVO.getMonthtotalprofitPrice() - (monthVO.getMonthtotalPrice()*0.1)); 
	...
	public HeadMonthVO selectheadmonthChart(HeadMonthVO month) {
		...
		for(int i = 0; i < headmonthVO.size(); i++) {
			...
			int incomePrice = (int) (monthVO.getMonthtotalprofitPrice() - (monthVO.getMonthtotalPrice()*0.1)); 
